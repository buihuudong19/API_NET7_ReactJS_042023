        ...
        <div className="row px-xl-5">
            ...
            <div className="col-lg-7 pb-5">
                ...
                <div className="d-flex align-items-center mb-4 pt-2">
                    <div className="input-group quantity mr-3" style={{width: styleCommon.width130px}}/>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="media mb-4">
                                    <img src="img/user.jpg" alt="Image" className="img-fluid mr-3 mt-1" style={{width:styleCommon.width45px}}/>
